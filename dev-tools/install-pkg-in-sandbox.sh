...
echoStepMsg "Attempt to install package $PACKAGE_VERSION_ID into the org aliased as $SUBSCRIBER_ORG_ALIAS"
echo \
...
echoStepMsg "List all packages installed in $SUBSCRIBER_ORG_ALIAS"
